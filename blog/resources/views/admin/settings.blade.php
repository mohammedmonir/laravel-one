...
@section('content')
 ...
 <div class="box" style='padding:2%'>
        <div class="box-header" >
                    ...
                    {!!Form::open(['url'=>url('admin/settings'),'files'=>true,'enctype'=>'multipart/form-data'])!!}
                    <div>
                    ...
                    <div class='form-group'>
                            ...
                            @if(!empty(setting()->logo))
                                <img src='{{Storage::url(setting()->logo)}}' style='width:15%;height:15%'/>
                            @endif
                    </div>
                    <div class='form-group'>
                            ...
                            @if(!empty(setting()->icon))
                                <img src='{{Storage::url(setting()->icon)}}' style='width:15%;height:15%'/>
                            @endif
                    </div>
                    <div class='form-group'>
